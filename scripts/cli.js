...
const contractABI = require("../artifacts/contracts/Torchweaver.sol/Torchweaver.json").abi;

program
    .name("torchweaver-cli")
    .description("CLI tool for Torchweaver smart contract")
    .version("1.0.0");
