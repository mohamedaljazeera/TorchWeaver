 ...
 * This file demonstrates how to integrate Torchweaver with a web frontend
 */

// For React/Vue/Angular applications
export class TorchweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TorchweaverClient(provider, contractAddress);
